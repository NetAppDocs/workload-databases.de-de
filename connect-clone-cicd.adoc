...
[role="lead"]
Verbinden Sie einen Sandbox-Klon mit einer CI/CD-Pipeline (Continuous Integration and Continuous Delivery) mit REST-API-Code und verbessern Sie so die Softwarebereitstellung durch Automatisierung.
