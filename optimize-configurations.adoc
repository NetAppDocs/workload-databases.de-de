...
* Speicherkonfiguration: umfasst Kapazitätsverwaltung, Thin Provisioning, Tiering-Richtlinie, Snapshots, Speichereffizienz und Betriebssystemkonfigurationen für Bereitstellungen mit iSCSI mit oder ohne Automatic Storage Management (ASM), einschließlich Microsoft Multipath I/O (MPIO)-Status und -Einstellungen
