...
* *Anmeldeinformationen und Berechtigungen*: Es müssen link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["AWS-Kontoanmeldeinformationen und Berechtigungen für _Operationen und Behebungen_"^] vorhanden sein, um einen Sandbox-Klon in Workload Factory zu erstellen.
+
