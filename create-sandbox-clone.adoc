...
* *Anmeldeinformationen und Berechtigungen*: Sie müssenlink:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["AWS-Kontoanmeldeinformationen und Berechtigungen für den Nur-Lese- oder Lese-/Schreibmodus"^] um einen Sandbox-Klon in Workload Factory zu erstellen.
+
