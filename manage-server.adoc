...
[cols="2,2a"]
|===
| Melden Sie sich an | Wo erforderlich? 


| `VIEW ANY DEFINITION`  a| 
Bestandsaufnahme, Bewertung, Korrektur, Datenbank erstellen, Sandbox-Klon erstellen, Einsparungen entdecken



| `CONNECT ANY DATABASE`  a| 
Bestandsaufnahme, Bewertung, Korrektur, Datenbank erstellen, Sandbox-Klon erstellen
...
Datenbank erstellen und Sandbox-Klon erstellen



| `CONTROL SERVER`  a| 
Sandbox-Klon erstellen
...
| `ALTER SETTINGS`  a| 
Sandbox-Klon erstellen, Korrektur für MAXDOP
