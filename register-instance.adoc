...
Der Host für die Instanz oder Datenbank muss im Inventar erscheinen. Damit Hosts im Inventar angezeigt werden,link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["Sie müssen AWS-Kontoanmeldeinformationen und Berechtigungen für den _Nur-Lese-_ oder _Lese-/Schreibmodus_ hinzufügen"^] .
