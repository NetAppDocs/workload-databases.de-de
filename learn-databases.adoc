...
| Microsoft SQL Server | SQL Server 2016, 2019, 2022 | Beliebig | Always On-Verfügbarkeitsgruppen 
...
| Orakel | 19c | RHEL, SuSe Linux | Datenschützer 


| Orakel | 21c | RHEL, SuSe Linux | Datenschützer 
