...
.Bevor Sie beginnen
Folgende Voraussetzungen sind zu erfüllen, bevor eine neue Datenbank erstellt wird.

* *Anmeldeinformationen und Berechtigungen*: Sie müssen link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["AWS-Kontoanmeldeinformationen und Berechtigungen für _Operationen und Behebungen_"^] besitzen, um eine neue Datenbank in Workload Factory zu erstellen.
+
