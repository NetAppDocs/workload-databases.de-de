...
* *Anmeldeinformationen und Berechtigungen*: Sie müssenlink:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["AWS-Kontoanmeldeinformationen und Berechtigungen für den Nur-Lese- oder Lese-/Schreibmodus"^] um eine neue Datenbank in der Workload Factory zu erstellen.
+
